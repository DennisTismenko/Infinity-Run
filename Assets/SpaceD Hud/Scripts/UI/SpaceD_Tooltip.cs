...
[AddComponentMenu("SpaceD UI/Tooltip")]
public class SpaceD_Tooltip : MonoBehaviour
{
	...
	private static SpaceD_Tooltip mInstance;
	...
	private void _Show()
	{
		...
		{
			bool isLeft = true;
			SpaceD_Tooltip_AttributeRow lastAttrRow = null;
			...
			foreach (AttributeInfo info in this.mAttributes)
			{
				...
				if (isLeft)
				{
					...
					lastAttrRow = obj.GetComponent<SpaceD_Tooltip_AttributeRow>();
					...
					// If this is the first row add top margin
